...
//   return json({ currentPlanId: planId, campaignCount, managedPricingUrl });
// };
...
//   const currentPlan = PLAN_DISPLAY.find((p) => p.id === currentPlanId) || null;
...
//         <Banner tone="info">
//           <p>
//             🎉 All plans include a <strong>{TRIAL_DAYS}-day free trial</strong>.
...
//           <Banner tone="warning">
//             <p>
//               You don't have an active subscription. Start your{" "}
//               <strong>{TRIAL_DAYS}-day free trial</strong> by choosing a plan
//               below.
//             </p>
//           </Banner>
//         )}
