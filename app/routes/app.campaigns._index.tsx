...
//         // Search by title pattern — catches all tier sub-discounts
//         const searchRes = await admin.graphql(
...
//         // Fallback: scan all discounts when search returns nothing
//         if (nodes.length === 0) {
//           const allRes = await admin.graphql(
//             `#graphql query {
//               discountNodes(first: 100) {
...
//         // Merge direct-id and title matches, deduped
//         const idsToDelete = new Set<string>(directIds);
//         const idTypenames: Record<string, string> = { ...directTypenames };
